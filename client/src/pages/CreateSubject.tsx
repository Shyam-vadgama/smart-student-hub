...
        mutationFn: (data: { name: string; faculty: string; classroom: string; semester: string }) => // Added semester to mutationFn
...
    }
    
    if (!classroom) { // Added validation for classroom
      toast({
        title: 'Validation Error',
...
      return;
    }    
    if (!semester) { // Added validation for semester
      toast({
        title: 'Validation Error',
        description: 'Please enter a semester.',
        variant: 'destructive',
      });
      return;
    }
